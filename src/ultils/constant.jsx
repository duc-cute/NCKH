 ...
 <main style="height: 800px;width: 800px;max-height: 100vh ;font-family: sans-serif;">
  ...
  <div style="height: 100%; width: 100%;">
    ...
    <div style="color: #000;  background-color: #fff;margin: 24px;padding: 24px;border-radius: 20px;margin-top: 8px;">
          ...
          <tr>
            <td align="center">
              ...
              <div
                ...
                <div style="width: 220px;margin: 12px auto;">
                  <img style="width: 100%; height: 100%; object-fit: contain;"
                    src="https://static.topcv.vn/company_logos/1ZBhWcwHtuLHOmyChDBbc01TlA8wUVQT_1639127653____512fb0dfe6913e2f14bfba6896eec801.jpg" alt="">
                </div>
                <span
                  ...
                  style="display:inline-block;padding:12px 8px;font-family:SF Pro Text,Roboto,Segoe UI,helvetica neue,helvetica,arial,sans-serif;font-size:32px;line-height:23px;font-weight:700;color:red;text-decoration:none;">
      ...
      <div
        style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:14px;color:rgba(0,0,0,0.87);line-height:20px;padding-top:12px;text-align:left">
        Cố vấn học tập,
        <h3>Nguyễn Văn A</h3>
        <br />
      </div>
